        ...
        <li class="treeview">
         ...
         <li><a href="{{url('/admin/productcategory')}}" target="_blank"><span class="fa fa-cubes"></span> Product Category</a></li>
                    ...
                    <li><a href="{{url('/admin/products')}}"><span class="glyphicon glyphicon-hdd" aria-hidden="true"></span><span class="hidden-tablet"> Products</span></a></li>
                        ...
                        <li><a href="{{url('/admin/supplier')}}"><span class="glyphicon glyphicon-user" aria-hidden="true"></span><span class="hidden-tablet"> Suppliers</span></a></li>
                        ...
                        <li><a href="{{url('/admin/purchase')}}"><i class="icon-list-alt" aria-hidden="true"></i><span class="hidden-tablet"> Purchase</span></a></li>
                         <li><a href="{{url('/admin/sales')}}"><i class="icon-list-alt" aria-hidden="true"></i><span class="hidden-tablet"> Sales</span></a></li>
                         <li><a href="{{url('/admin/photos')}}"><i class="icon-list-alt" aria-hidden="true"></i><span class="hidden-tablet"> Photos</span></a></li>
        <li>
